...
{
    public class PastPaper2n3Repository : ControllerBase, IPastPaper2n3Repository
    {
        private readonly ApplicationDbContext _context;

        public PastPaper2n3Repository(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.PastPapers.Where(p => p.PaperNumber == 2 || p.PaperNumber == 3).ToListAsync();
        }
